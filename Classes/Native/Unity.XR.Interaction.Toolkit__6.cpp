...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FloatMaterialPropertyAffordanceReceiver_OnValidate_m9E8516112150C41ABBCB847C8E0B12749301A478 (FloatMaterialPropertyAffordanceReceiver_t0C20A38C8319B3043C68C2DF86E7CCDB0846A251* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___m_MaterialPropertyBlockHelper_18 = L_3;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___m_MaterialPropertyBlockHelper_18), (void*)L_3);
	}
...
IL_0024:
	{
		// m_FloatProperty = Shader.PropertyToID(m_FloatPropertyName);
		String_t* L_4 = __this->___m_FloatPropertyName_19;
		int32_t L_5;
		L_5 = Shader_PropertyToID_mE98523D50F5656CAE89B30695C458253EB8956CA(L_4, NULL);
		__this->___m_FloatProperty_20 = L_5;
		// }
		return;
	}
}
...
IL_0024:
	{
		// m_Vector2Property = Shader.PropertyToID(m_Vector2PropertyName);
		String_t* L_4 = __this->___m_Vector2PropertyName_19;
		int32_t L_5;
		L_5 = Shader_PropertyToID_mE98523D50F5656CAE89B30695C458253EB8956CA(L_4, NULL);
		__this->___m_Vector2Property_20 = L_5;
		// }
		return;
	}
}
...
IL_0024:
	{
		// m_Vector3Property = Shader.PropertyToID(m_Vector3PropertyName);
		String_t* L_4 = __this->___m_Vector3PropertyName_19;
		int32_t L_5;
		L_5 = Shader_PropertyToID_mE98523D50F5656CAE89B30695C458253EB8956CA(L_4, NULL);
		__this->___m_Vector3Property_20 = L_5;
		// }
		return;
	}
}
...
IL_0024:
	{
		// m_Vector4Property = Shader.PropertyToID(m_Vector4PropertyName);
		String_t* L_4 = __this->___m_Vector4PropertyName_19;
		int32_t L_5;
		L_5 = Shader_PropertyToID_mE98523D50F5656CAE89B30695C458253EB8956CA(L_4, NULL);
		__this->___m_Vector4Property_20 = L_5;
		// }
		return;
	}
}
...
IL_002e:
	{
		...
		V_1 = (bool)((((RuntimeObject*)(AudioAffordanceThemeDatumProperty_t6C3F44447E2B121AC858FAC94C4A83CC5D52C6D8*)L_4) == ((RuntimeObject*)(RuntimeObject*)NULL))? 1 : 0);
		bool L_5 = V_1;
		if (!L_5)
		{
			goto IL_0058;
...
IL_0058:
	{
		...
		BindingsGroup_tD5EC90BB10F9D310FE467A7E3A4CAE2E32D0397A* L_7 = __this->___m_BindingsGroup_7;
		BaseAffordanceStateProvider_t5721F9B16D6C029D832F8D6FA0A47326A581D443* L_8 = __this->___m_AffordanceStateProvider_4;
		NullCheck(L_8);
		RuntimeObject* L_9;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AudioAffordanceReceiver_OnAffordanceStateUpdated_m87547740A5FF0FCDC246EC6041B86C1881EBF03B (AudioAffordanceReceiver_t68854DF37FCFBBCC267549644D37D433B6CC1010* __this, AffordanceStateData_t925209B85B56D04F7F178061B1C91280DA6DBC69 ___0_affordanceStateData, const RuntimeMethod* method) 
{
	...
	bool V_0 = false;
	AudioAffordanceThemeData_t3F29C6FF9ED5593AF503785A5C7FE342A1EE9D0D* V_1 = NULL;
	AudioAffordanceThemeData_t3F29C6FF9ED5593AF503785A5C7FE342A1EE9D0D* V_2 = NULL;
	bool V_3 = false;
	bool V_4 = false;
	{
		...
		uint8_t L_1 = __this->___m_LastAffordanceStateIndex_8;
	...
	}
	{
		...
		NullCheck(L_3);
		AudioAffordanceTheme_t8BF9C6D960CBE2CE7F33C4B4960F794790DD3CCE* L_4;
		L_4 = DatumProperty_2_get_Value_m9D784B9C34F96D570FF46D3F6E0959CD1CD68718(L_3, DatumProperty_2_get_Value_m9D784B9C34F96D570FF46D3F6E0959CD1CD68718_RuntimeMethod_var);
		uint8_t L_5 = __this->___m_LastAffordanceStateIndex_8;
		NullCheck(L_4);
		...
		V_1 = L_6;
		// if (exitData != default)
		AudioAffordanceThemeData_t3F29C6FF9ED5593AF503785A5C7FE342A1EE9D0D* L_7 = V_1;
		V_3 = (bool)((!(((RuntimeObject*)(AudioAffordanceThemeData_t3F29C6FF9ED5593AF503785A5C7FE342A1EE9D0D*)L_7) <= ((RuntimeObject*)(RuntimeObject*)NULL)))? 1 : 0);
		bool L_8 = V_3;
		if (!L_8)
		{
			goto IL_0046;
	...
	}
	{
		...
		AudioAffordanceThemeData_t3F29C6FF9ED5593AF503785A5C7FE342A1EE9D0D* L_9 = V_1;
		NullCheck(L_9);
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_10 = L_9->___stateExited_2;
		AudioAffordanceReceiver_PlayAudioClip_m6CE8491BBBAC91F254052CCDBE7B0D4C52C9237F(__this, L_10, NULL);
	}

IL_0046:
	{
		// var enterData = m_AffordanceThemeDatum.Value.GetAffordanceThemeDataForIndex(affordanceStateData.stateIndex);
		AudioAffordanceThemeDatumProperty_t6C3F44447E2B121AC858FAC94C4A83CC5D52C6D8* L_11 = __this->___m_AffordanceThemeDatum_5;
		NullCheck(L_11);
		AudioAffordanceTheme_t8BF9C6D960CBE2CE7F33C4B4960F794790DD3CCE* L_12;
		L_12 = DatumProperty_2_get_Value_m9D784B9C34F96D570FF46D3F6E0959CD1CD68718(L_11, DatumProperty_2_get_Value_m9D784B9C34F96D570FF46D3F6E0959CD1CD68718_RuntimeMethod_var);
		uint8_t L_13;
		L_13 = AffordanceStateData_get_stateIndex_m2B9DFBBB1FE3AE1BC2BAC900B2493B72B4D8F341_inline((&___0_affordanceStateData), NULL);
		NullCheck(L_12);
		AudioAffordanceThemeData_t3F29C6FF9ED5593AF503785A5C7FE342A1EE9D0D* L_14;
		L_14 = AudioAffordanceTheme_GetAffordanceThemeDataForIndex_mF454F28C7CB781D17D32C4E04310EC400CF78D7E(L_12, L_13, NULL);
		V_2 = L_14;
		// if (enterData != default)
		AudioAffordanceThemeData_t3F29C6FF9ED5593AF503785A5C7FE342A1EE9D0D* L_15 = V_2;
		V_4 = (bool)((!(((RuntimeObject*)(AudioAffordanceThemeData_t3F29C6FF9ED5593AF503785A5C7FE342A1EE9D0D*)L_15) <= ((RuntimeObject*)(RuntimeObject*)NULL)))? 1 : 0);
		bool L_16 = V_4;
		if (!L_16)
		{
			goto IL_0077;
	...
	}
	{
		...
		AudioAffordanceThemeData_t3F29C6FF9ED5593AF503785A5C7FE342A1EE9D0D* L_17 = V_2;
		NullCheck(L_17);
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_18 = L_17->___stateEntered_1;
		AudioAffordanceReceiver_PlayAudioClip_m6CE8491BBBAC91F254052CCDBE7B0D4C52C9237F(__this, L_18, NULL);
	}
...
IL_0078:
	{
		...
		uint8_t L_19;
		L_19 = AffordanceStateData_get_stateIndex_m2B9DFBBB1FE3AE1BC2BAC900B2493B72B4D8F341_inline((&___0_affordanceStateData), NULL);
		__this->___m_LastAffordanceStateIndex_8 = L_19;
		// }
		return;
	}
}
...
{
	{
		...
		BaseAffordanceTheme_1_t0E9523F1B0AB080EFF2F713F31C00A868A4A3A80* L_0 = __this->___m_AffordanceTheme_6;
		return L_0;
	}
}
IL2CPP_MANAGED_FORCE_INLINE IL2CPP_METHOD_ATTR void Vector4__ctor_m96B2CD8B862B271F513AF0BDC2EABD58E4DBC813_inline (Vector4_t58B63D32F48C0DBF50DE2C60794C4676C80EDBE3* __this, float ___0_x, float ___1_y, float ___2_z, float ___3_w, const RuntimeMethod* method) 
